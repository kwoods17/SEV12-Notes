...
// const sumArray = numbers => numbers.reduce((accumulator, currentValue) => accumulator + currentValue)
// console.log(sumArray(nums))

/* Question 2
Write a HOF to reduce all numbers in an array to all numbers multiplied together */
// const array2 = numbers => numbers.reduce((accumulator, currentValue) => accumulator * currentValue)
// console.log(array2(nums))
...
console.log(partyPeople.reduce(accumulator, currentValue) => Math.max( people, people.age[0])))